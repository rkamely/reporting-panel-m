...
import {IoIosArrowDown, VscBell} from "react-icons/all";
...
const Announce = () => {
    ...
    return (
        <div className='mainPageContentFrame'>
            ...
            <DashboardSectionHeader title={FaStaticTexts.announceColorSectionTitle} icon={<VscBell />} color='blueGradiantBox'
                message={FaStaticTexts.announceColorSectionMessage} />
            <div className='tableOfContentStyle'>
                <Hidden only={['sm', 'xs']}>
                    <div className='tableOfContentHeader'>
                        <ul>
                            <li style={{width: '10%'}}>{FaStaticTexts.rowStaticText}</li>
                            <li style={{width: '90%'}}>{FaStaticTexts.announceTitleOfHeader}</li>
                        </ul>
                    </div>
                </Hidden>
                {
                                ...
                                <ExpansionPanel
                                    ...
                                    <ExpansionPanelSummary
                                        ...
                                        <div className='eachRowOfTableStyle'>
                                            ...
                                            <TableOfContentRowCell width='90%' title={FaStaticTexts.announceTitleOfHeader} text={item.title} />
                                        </div>
                                    </ExpansionPanelSummary>
