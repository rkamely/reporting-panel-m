...
const MTNRFMList = () => {
    ...
    return (
        <div className='mainPageContentFrame'>
            ...
            <DashboardSectionHeader title={FaStaticTexts.mtnGroupRFMColorSectionTitle} icon={<BsFileEarmarkText />} 
                    color='blueGradiantBox' message={FaStaticTexts.mtnGroupRFMColorSectionMessage} />
...
export default connect(mapStateToProps)(MTNRFMList);
