...
import {AiOutlineCalendar, FiLayers, IoIosArrowDown} from "react-icons/all";
...
const MTNCampaignReport = () => {
    ...
    const handleSubmitForm = (e) => {
        FormValidation(transactionType, mobileNumber, fromDate, toDate)
    ...
    return (
        <div className='mainPageContentFrame'>
            ...
            <DashboardSectionHeader title={FaStaticTexts.mtnReportCampaignSendGiftTitle}
            ...
            <div className='tableOfContentStyle'>
                <div className='dashboardFilterRegFrame'>
                    <div className='dashboardFrameColumnDirection'>
                        <div className='dashboardSectionInputsInRow'>
                            <FormControl className='customSelectOptionInRow'>
                                        <span
                                            className='inputLabel'>{transactionType === '' ? 'نوع تراکنش' : transactionType}</span>
                                <Select
                                    id="demo-simple-select"
                                    value={transactionType}
                                    onChange={(e) => handleChangeInput(e, 'transactionType')}
                                >
                                    <MenuItem value='شارژ'>شارژ</MenuItem>
                                    <MenuItem value='بسته اینترنت'>بسته اینترنت</MenuItem>
                                    <MenuItem value='امتیاز'>امتیاز</MenuItem>
                                    <MenuItem value='شانس'>شانس</MenuItem>
                                </Select>
                                <span className="errorText"> {errors ? errors.transactionType : null} </span>
                            </FormControl>
                            <InputWithIcon
                                title='تلفن همراه' inputType='text' handleChange={(e) => handleChangeInput(e, 'mobileNumber')}
                    ...
                    <Button className='applyFilterRegButton' onClick={(e) => handleSubmitForm()}>
                        جستجو
                    </Button>
                </div>
                {
...
export default MTNCampaignReport;